 ...
 * @returns
 */
export const componentTemplate = (iconWeights) => {
...
export const definitionsTemplate = (components) => {
...
export const componentDefinitionTemplate = (componentName) => {
...
export const moduleTemplate = (components) => {
  let str = "export { default as IconContext } from './IconContext.svelte';\n";
